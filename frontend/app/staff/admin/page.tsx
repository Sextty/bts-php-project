  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
        <div className="mb-6">
          <h1 className="text-title">Applications awaiting final decision</h1>
          {!loading && (
            <p className="text-sm text-muted-foreground">
              {applications.length === 0 ? 'Queue is empty' : `${applications.length} application${applications.length === 1 ? '' : 's'} to decide`}
            </p>
          )}
        </div>
