...
export function TrendChart({
  ...
  // Grid Ticks (4 horizontal grid levels for smooth readability)
  const ticks = useMemo(() => {
      ...
      <div className="relative">
        ...
        >
          <defs>
            ...
            {/* Subtle glow filter for the active line */}
            <filter id={`${gradPrefix}-glow`} x="-20%" y="-20%" width="140%" height="140%">
          ...
          {hover !== null && (
            <g>
              {/* Vertical soft column highlight */}
              <rect
