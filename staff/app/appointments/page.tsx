...
export default function StaffAppointmentsPage() {
  ...
  return (
    <div className="staff-page">
      ...
      <main id="main" className="staff-main space-y-8">
        {/* Header Title Section */}
        <div className="staff-page-hero flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[#FDF2F2] text-[#C0272D] border border-[#FECACA]">
                ...
                Espace Conseillers & Agences BTS
              </span>
            </div>
            <h1 className="font-display text-2xl font-bold tracking-tight text-[#0C1825] sm:text-3xl">
              Rendez-vous & Agences Bancaires
            </h1>
            <p className="text-xs sm:text-sm text-[#3D5166] mt-1">
              Planning complet des rendez-vous clients et annuaire interactif des 28 agences BTS Bank.
            </p>
          </div>
                          ...
                          <tr key={apt.id} className="hover:bg-[#FAFBFD] transition-colors">
                            ...
                            <td className="px-4 py-3.5">
                              {apt.application ? (
                                <div>
                                  <Link
                                    href={`/dashboard/${apt.application.id}`}
                              ...
                              {apt.application && (
                                <div className="inline-flex items-center gap-1.5">
                                  ...
                                  <Link
                                    ...
                                    title="Voir le dossier d'instruction"
                                  >
